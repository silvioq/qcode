...
#define yyparse qasmparse
#define yylex   qasmlex
#define yyerror qasmerror
#define yylval  qasmlval
#define yychar  qasmchar
#define yydebug qasmdebug
#define yynerrs qasmnerrs
